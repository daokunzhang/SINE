...
//  The SINE.c code was built upon the word2vec.c from https://code.google.com/archive/p/word2vec/
...
long long node_context_hash_size = 1000000000; // Maximum 1G node context pairs
...
int main(int argc, char **argv)
{
    ...
    if (argc == 1)
    {
        printf("---Scalable incomplete network embedding---\n");
